...
The data used in this paper was obtained through Statistics Canada and the Bank of Canada. The paper used two data sets:

-   **Statistics Canada:** Monthly average retail prices for selected products[^1]
-   **Bank of Canada:** Inflation: Definitions, graphs and data[^2]\

[^1]: Statistics Canada's "Monthly average retail prices for selected products" data set is available at: https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=1810024501

[^2]: The Bank of Canada's "Inflation: Definitions, graphs and data" data set is available at: https://bankofcanada.ca/rates/indicators/capacity-and-inflation-pressures/inflation
...
A special thank you to Chloe Thierstein, Linrong Li, and Sagith Kalaichelvam for reviewing and providing feedback on this paper.
\newpage
